...
public:
    ...
    */
    ...
    /**
        Setta le proprietà della luce puntiforme

        @param pl informazioni relative alla luce puntiforme
    */
    void set_point_light(unsigned int index, const PointLight &pl);

    /**
        Setta quante luci puntiformi usare

        @param count numero di luci da usare
    */
...
private:
    ...
    */
    ...
    GLint _num_point_lights_location;

    struct {
        GLint _point_color_location;
        GLint _point_position_location;
        GLint _point_intensity_location;
        GLint _point_range_location;
    } PointLightLocations[MAX_POINT_LIGHTS];

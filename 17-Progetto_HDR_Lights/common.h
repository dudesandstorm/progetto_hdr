...
#define MAX_POINT_LIGHTS 2 // when changing this, make sure to also change MAX_POINT_LIGHTS in fragment shader
#define MAX_SPOT_LIGHTS 2 // when changing this, make sure to also change MAX_SPOT_LIGHTS in fragment shader
